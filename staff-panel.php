...
if (isset($_GET['done'])) {
  $query = mysqli_query($con, "update laporan set status_pembayaran='Sudah' where ID = '" . $_GET['ID'] . "'");
  if ($query) {
...
<body style="padding-top:50px;">
  <div class="container-fluid" style="margin-top:50px;">
    <h3 style="margin-left: 40%; padding-bottom: 20px;font-family:'IBM Plex Sans', sans-serif;"> Selamat Datang <?php echo $_SESSION['username'] ?> </h3>
    <div class="row">
      <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
        <div class="list-group" id="list-tab" role="tablist">
          <a class="list-group-item list-group-item-action active" href="#list-dash" role="tab" aria-controls="home" data-toggle="list">Dashboard</a>
          <a class="list-group-item list-group-item-action" href="#list-app" id="list-app-list" role="tab" data-toggle="list" aria-controls="home">Daftar Pemeriksaan</a>
        </div><br>
      </div>
                ...
                <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> Daftar Pemeriksaan</h4>
                      <script>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if (($row['status_pembayaran'] != 'Sudah')) { ?>
                        ...
                        <a href="staff-panel.php?ID=<?php echo $row['ID'] ?>&done=update" onClick="return confirm('Yakin selesai?')" title="Selesai" tooltip-placement="top" tooltip="Remove"><button class="btn btn-success">V</button></a>
          ...
          <div class="tab-pane fade" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
            <table class="table table-hover">
              ...
              <tbody>
                ...
                $query = "select pid,fname,lname,ID,tanggal,waktu,diagnosa,alergi,resep from laporan where dokter='$dokter';";
